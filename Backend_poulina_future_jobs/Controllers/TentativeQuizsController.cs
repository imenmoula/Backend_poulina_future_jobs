    ...
    public class TentativeQuizController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<TentativeQuizResponseDto>>> GetTentativesByUser(Guid userId)
        {
            ...
            var tentatives = await _context.TentativesQuiz
                ...
                .Select(t => new TentativeQuizResponseDto
                {
                    ...
                    DateDebut = (DateTime)t.DateDebut,
                    DateFin = t.DateFin,
                    Statut = t.Statut,
        ...
        public async Task<ActionResult<TentativeQuizDetailDto>> GetTentative(Guid id)
        {
            ...
            var tentativeDto = new TentativeQuizDetailDto
            {
                ...
                DateDebut = (DateTime)tentative.DateDebut,
                DateFin = tentative.DateFin,
                Statut = tentative.Statut,
                Score = (double)tentative.Score,
        ...
        public async Task<ActionResult<ResultatQuizDto>> SubmitTentative(Guid id, SubmitTentativeDto dto)
        {
            ...
            var tempsTotal = tentative.DateFin.HasValue && tentative.DateDebut.HasValue
                ? (int)(tentative.DateFin.Value - tentative.DateDebut.Value).TotalSeconds
                : 0;
        ...
        //// TentativeQuizController.cs
        //[HttpPost("Start")]
        //[AllowAnonymous] // Autoriser l'accès sans authentification
        //public async Task<ActionResult<TentativeQuizResponseDto>> StartTentativeWithToken(
        //    [FromBody] StartTentativeWithTokenDto dto)
        //{
        //    // Valider le token
        //    var tentative = await _context.TentativesQuiz
        //        .Include(t => t.Quiz)
        ...
        //    if (tentative.Token != dto.Token) return Unauthorized("Token invalide");
        ...
        //    return Ok(new TentativeQuizResponseDto
        //    {
        //        TentativeId = tentative.TentativeId,
        //        QuizId = tentative.QuizId,
        //        QuizTitre = tentative.Quiz.Titre,
        //        QuizDuree = tentative.Quiz.Duree,
        //        DateDebut = tentative.DateDebut.Value
        //    });
        //}

        //public class StartTentativeWithTokenDto
        //{
        //    [Required] public Guid TentativeId { get; set; }
        //    [Required] public string Token { get; set; }
        //}

        public class TentativeStatusDto
        {
            public StatutTentative Statut { get; set; }
            public int? TempsRestant { get; set; } // en secondes
        }
    }
}