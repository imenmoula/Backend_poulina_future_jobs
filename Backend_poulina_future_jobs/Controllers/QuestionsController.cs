...
namespace Backend_poulina_future_jobs.Controllers
{
    ...
    public class QuestionController : ControllerBase
    {
        ...
        [HttpGet("Quiz/{quizId}")]
        [AllowAnonymous]
        public async Task<ActionResult<IEnumerable<QuestionResponseDtos>>> GetQuestionsByQuiz(Guid quizId)
        {
            var questions = await _context.Questions
                .Where(q => q.QuizId == quizId)
                .Include(q => q.Reponses)
                .OrderBy(q => q.Ordre)
                .Select(q => new QuestionResponseDtos
                {
        ...
        [HttpGet("{id}")]
        [AllowAnonymous]
        public async Task<ActionResult<QuestionResponseDtos>> GetQuestion(Guid id)
        {
        ...
        public async Task<ActionResult<QuestionResponseDtos>> CreateQuestion(QuestionCreateDto dto)
        {
            ...
            var questionDto = new QuestionResponseDtos
            {
                QuestionId = question.QuestionId,
        ...
        [HttpPut("{id}")]
        [Authorize(Roles = "Admin,Recruteur")]
        public async Task<IActionResult> UpdateQuestion(Guid id, QuestionUpdateDtos dto)
        {
    ...
    // DTOs pour Question
    public class QuestionCreateDtos
    {
        [Required]
        [StringLength(500)]
    ...
    public class QuestionUpdateDtos
    {
        [StringLength(500)]
        public string Texte { get; set; }
    ...
    public class QuestionResponseDtos
    {
